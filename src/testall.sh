...
echo './signa -g ~/qemu/mem-2.6.36.4a3 ~/qemu/mem-2.6.36.4a > 2.6.36.4'
./signa -g ~/qemu/mem-2.6.38.2-b ~/qemu/mem-2.6.38.2-a > 2.6.38.2
echo './signa -g ~/qemu/mem-2.6.38.2-b ~/qemu/mem-2.6.38.2-a > 2.6.38.2'
./signa -g ~/qemu/mem-3.0.0-11 ~/qemu/mem-3.0.0-20 > 3.0.0
echo './signa -g ~/qemu/mem-3.0.0-11 ~/qemu/mem-3.0.0-20 > 3.0.0'
